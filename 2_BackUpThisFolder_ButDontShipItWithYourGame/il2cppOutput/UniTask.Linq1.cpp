...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool PlayerLoopHelper_get_IsMainThread_mACAE8B3CE3D29DF3044F6A2860BC854543E5CB66 (const RuntimeMethod* method) ;
...
IL_007d_2:
			{
				...
				L_16 = Decimal_op_Addition_m79AD1C3ED1E6345D50110EA4D20DAE724724B9DA(L_14, L_15, NULL);
...
IL_0196_1:
		{
			...
			L_46 = ExceptionDispatchInfo_Capture_mD989ED7E69753F2E0A2076B60ACA8819F14DA93E(G_B25_0, NULL);
			NullCheck(L_46);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void _EveryUpdate__ctor_mDB9A677C44C8552AAD4C6D88F14499AE5FC05D09 (_EveryUpdate_t1BDE92B21B6FC1B5BDD80BE162E182EC0AFA9310* __this, int32_t ___updateTiming0, CancellationToken_t51142D9C6D7C02D314DA34A6A7988C528992FFED ___cancellationToken1, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		PlayerLoopHelper_AddAction_m931B31EF10AFD9A839BEDF52549737FF70AF0C31(L_2, __this, NULL);
		// }
		return;
	}
}
...
IL_0099:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(PlayerLoopHelper_tA497C2C44D13E21B40E76B01973260BB49C9CF01_il2cpp_TypeInfo_var);
		bool L_14;
		L_14 = PlayerLoopHelper_get_IsMainThread_mACAE8B3CE3D29DF3044F6A2860BC854543E5CB66(NULL);
		G_B9_0 = __this;
		if (L_14)
		{
			G_B10_0 = __this;
...
IL_00a9:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(PlayerLoopHelper_tA497C2C44D13E21B40E76B01973260BB49C9CF01_il2cpp_TypeInfo_var);
		PlayerLoopHelper_AddAction_m931B31EF10AFD9A839BEDF52549737FF70AF0C31(L_19, __this, NULL);
		// }
		return;
	}
}
...
IL_00c9:
	{
		float L_24;
		L_24 = Time_get_unscaledDeltaTime_m89252D23CC5AA295CFA4EB2BCB417A831AC51652(NULL);
		G_B17_0 = L_24;
		G_B17_1 = G_B16_0;
		G_B17_2 = G_B16_1;
	}
...
IL_0039:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(PlayerLoopHelper_tA497C2C44D13E21B40E76B01973260BB49C9CF01_il2cpp_TypeInfo_var);
		bool L_6;
		L_6 = PlayerLoopHelper_get_IsMainThread_mACAE8B3CE3D29DF3044F6A2860BC854543E5CB66(NULL);
		G_B6_0 = __this;
		if (L_6)
		{
			G_B7_0 = __this;
...
IL_0049:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(PlayerLoopHelper_tA497C2C44D13E21B40E76B01973260BB49C9CF01_il2cpp_TypeInfo_var);
		PlayerLoopHelper_AddAction_m931B31EF10AFD9A839BEDF52549737FF70AF0C31(L_11, __this, NULL);
		// }
		return;
	}
}
...
IL_0052:
	{
		...
		int32_t L_11;
		L_11 = Time_get_frameCount_m88E5008FE9451A892DE1F43DC8587213075890A8(NULL);
